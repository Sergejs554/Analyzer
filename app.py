...
_MX_EDGE_MIX = float(os.getenv("MX_EDGE_MIX", "0.125"))
...
_MX_AIR_G = float(os.getenv("MX_AIR_G", "0.86"))
...
_MX_TRIM_DB = float(os.getenv("MX_TRIM_DB", "0.95"))
