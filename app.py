...
# --- Sheen ---
_SH_HP = float(os.getenv("SH_HP", "5950"))
_SH_LP = float(os.getenv("SH_LP", "9150"))
_SH_DRIVE = float(os.getenv("SH_DRIVE", "1.22"))
_SH_MIX = float(os.getenv("SH_MIX", "0.158"))
...
_SH_TEXTURE_GAIN = float(os.getenv("SH_TEXTURE_GAIN", "0.60"))
