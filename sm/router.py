...
def apply_interaction_clamps(
    ...
    # 1. Body weakness / fragility protects against dense cleanup.
    ...
    # 2. Broken bridge / risky gap protects bridge zone from aggressive cleanup.
    ...
    # 3. Gluey bridge limits bridge aggression and slightly restrains anchor restore.
    if ctx.bridge_gluey:
    ...
    # 4. Cleanup-primary dense cannot carry dense projection in same pass.
    ...
    # 5. Active boxiness control cannot carry dense projection.
    ...
    # 6. Underprojected / not fully established projection blocks excited spark.
    ...
    # 7. Top fragile clamps projection and disables spark.
    if ctx.top_fragile:
        projection = _apply_plan_clamp(
            projection,
            max_amount=0.16,
    ...
    # 8. Thin material cannot take subtractive double-hit.
    ...
    # 9. Spark can never outrun projection dynamic scale.
